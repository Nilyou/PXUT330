...
#define f_size(x) (x)->fsize
extern int SDCard_UnInit(void);

extern int SDCard_Init(void);
extern int SDCard_Mount(void);
extern unsigned SdCard_Format(void);
unsigned SdCard_GetCapacity(DWORD *pFreeCluster, DWORD *pLastCluster);
